      ...
      <div className="flex-1 px-4 md:px-12 py-16 md:py-20 flex flex-col lg:flex-row justify-between items-start gap-10 lg:gap-16">
        ...
        <div className="w-full lg:max-w-[420px] flex flex-col gap-4">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-[rgba(55,50,47,0.16)] w-fit">
            ...
            <span className="text-[#605A57] text-xs font-medium leading-4">Custom Model</span>
          </div>
            ...
            {signals.map((signal, i) => (
              <li key={i} className="flex items-center gap-2.5">
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                  <path d="M13.5 4.5L6.5 11.5L3 8" stroke="#37322F" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
                <span className="text-[#49423D] text-sm font-medium">{signal}</span>
              </li>
            ))}
          </ul>
        </div>
        ...
        <div className="w-full lg:flex-1 p-6 md:p-8 bg-white border border-[#E0DEDB] flex flex-col gap-6">
          <div className="flex flex-col gap-1">
            <p className="text-[rgba(55,50,47,0.60)] text-xs font-medium uppercase tracking-widest">How it works</p>
            <div className="flex flex-col gap-3 mt-3">
              {[
                ...
                <div key={step} className="flex items-start gap-4">
                  <span className="text-[rgba(55,50,47,0.30)] text-sm font-medium font-serif w-6 shrink-0 pt-0.5">{step}</span>
