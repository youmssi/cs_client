...
export function CTA({ heading, sub_heading, CTAs: ctas }: Readonly<CTABlock>) {
  return (
    <section id={ANCHORS.CONTACT} className="w-full relative overflow-hidden flex flex-col justify-center items-center gap-2">
      <div className="self-stretch px-6 md:px-24 py-12 md:py-16 border-t border-b border-brand-ink/12 flex justify-center items-center gap-6 relative z-10">
        ...
        <div className="w-full max-w-[586px] px-6 py-5 md:py-8 overflow-hidden rounded-lg flex flex-col justify-start items-center gap-6 relative z-20">
          <div className="self-stretch flex flex-col justify-start items-start gap-3">
            <h2 className="self-stretch text-center flex justify-center flex-col text-brand-dark text-3xl md:text-5xl font-semibold leading-tight md:leading-[56px] font-sans tracking-tight">
              {heading}
            </h2>
            {sub_heading && (
              <p className="self-stretch text-center text-brand-text text-base leading-7 font-sans font-medium">
                {sub_heading}
              </p>
            )}
          </div>
